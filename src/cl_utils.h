...
typedef char voidchar;
#define _TYPE_LIST                                                            \
  X (voidchar, TYPE_UNKNOWN, host, "%c")                                      \
  X (float, TYPE_FLOAT, floats, "%f")                                         \
  X (double, TYPE_DOUBLE, doubles, "%lf")                                     \
  X (char, TYPE_CHAR, chars, "%c")                                            \
  X (short, TYPE_SHORT, shorts, "%hd")                                        \
  X (int, TYPE_INT, ints, "%d")                                               \
  X (long, TYPE_LONG, longs, "%ld")                                           \
  X (bool, TYPE_BOOL, bools, "%d")
...
typedef enum
{
#define X(_, enum_name, __, ___) enum_name,
  _TYPE_LIST
#undef X
} array_type;
...
typedef struct
{
  ...
  union
  {
#define X(type, _, name, __) type *name;
    _TYPE_LIST
#undef X
  };
} array;
